-- Enforce fixed 60-minute appointments for MVP
-- Ignoring p_end_time parameter and calculating end_time = start_time + 60 minutes
...
BEGIN
  -- FIX: For MVP, appointment duration is fixed to 60 minutes.
  -- We ignore the provided p_end_time and compute it strictly from start time.
  v_calculated_end_time := p_start_time + interval '60 minutes';
  ...
  v_end_wall := v_calculated_end_time AT TIME ZONE v_tz;
